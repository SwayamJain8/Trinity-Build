...
const page = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full mt-23">
      ...
      <div className="flex flex-col items-center justify-center w-full h-[70vh] px-10 pb-5">
        {userDetail && (
          <div
            className="p-5 border rounded-xl w-[70%] flex justify-between mt-5 items-center mr-47 "
